...
class GeminiStressThread(DockerBasedStressThread):  # pylint: disable=too-many-instance-attributes
    ...
    @property
    def gemini_oracle_statements_file(self):
        return f"gemini_oracle_statements_{self.unique_id}.log"

    @property
    def gemini_test_statements_file(self):
        return f"gemini_test_statements_{self.unique_id}.log"

    @property
    def gemini_result_file(self):
        return f"gemini_result_{self.unique_id}.log"
    ...
    def _generate_gemini_command(self):
        ...
        for key, value in self.gemini_default_flags:

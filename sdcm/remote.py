    ...
    def receive_files(self, src, dst, delete_dst=False,
        ...
        if self.use_rsync():
            try:
                ...
                try_scp = False
            except (process.CmdError, Failure, UnexpectedExit) as e:
                self.log.warning("Trying scp, rsync failed: %s", e)
                # Make sure master ssh available
    ...
    def send_files(self, src, dst, delete_dst=False,
        ...
        if self.use_rsync():
            try:
                ...
                try_scp = False
            except (process.CmdError, Failure, UnexpectedExit) as details:
                self.log.warning("Trying scp, rsync failed: %s", details)
        ...
        if try_scp:
            ...
            if delete_dst:
                ...
                try:
                    ...
                    if r.ok:
                        dest_exists = True
                except (process.CmdError, Failure, UnexpectedExit):
                    pass

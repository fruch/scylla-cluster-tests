...
_CLOUD_API_PATCHES = {
    ...
    # pathlib.Path.is_file — always True so pydantic's _file() validator passes
    # (BeforeValidator captures the function reference at class-definition time,
    #  so patching sdcm.sct_config._file has no effect)
